...
* Про параметры, которые были важными (остальные описывал выше):
  * [shared_buffers](https://postgrespro.ru/docs/postgrespro/15/runtime-config-resource#GUC-SHARED-BUFFERS). Начальное значение будет-25% от объёма памяти.
