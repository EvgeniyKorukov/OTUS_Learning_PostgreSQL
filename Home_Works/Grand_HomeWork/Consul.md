...
### Какие возможности у нас появились на данном этапе
  ...
  |:--:|:---|:--------|:----------|------:|:------------------------------------------|
  | :heavy_check_mark: | `Consul` | **`pg-srv1`** | `10.129.0.21` | 8500 | Веб-интерфейс |
  | :heavy_check_mark: | `Consul` | **`pg-srv2`** | `10.129.0.22` | 8500 | Веб-интерфейс |
  | :heavy_check_mark: | `Consul` | **`pg-srv3`** | `10.129.0.23` | 8500 | Веб-интерфейс |
