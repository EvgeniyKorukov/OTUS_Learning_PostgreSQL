<div align="center"><h2> 8. Проверка отказоустойчивости при падении HA Proxy и переносе VIP с помощью KeepAlived </h2></div>
...
***
### У `HAProxy` есть полезный и информативный веб-интерфейс
<kbd>
  <img src="config_files/test_ha_vip11.jpg" />
</kbd>    


***

### :+1: Проверка отказоустойчивости при падении HA Proxy и переносе VIP с помощью KeepAlived пройдена!
