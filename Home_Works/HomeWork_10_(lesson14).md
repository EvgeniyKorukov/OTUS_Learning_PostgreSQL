...
> ### 1. На 1 ВМ создаем таблицы test для записи, test2 для запросов на чтение.
  * Создаем ВМ 1
    ...
    id: epdjfp0na2cbdoj2t7k3
    folder_id: b1g59qc1dbgj9fu1qp9t
    created_at: "2023-05-28T20:34:02Z"
    name: pg-srv1
    ...
    boot_disk:
      mode: READ_WRITE
      device_name: epd47f72t838tb61r6bd
      auto_delete: true
      disk_id: epd47f72t838tb61r6bd
    network_interfaces:
      - index: "0"
        mac_address: d0:0d:13:7e:41:75
        subnet_id: e2lamcqbnklme222m12r
        primary_v4_address:
          address: 10.129.0.21
          one_to_one_nat:
            address: 51.250.19.127
            ip_version: IPV4
    gpu_settings: {}
  ...
  * Устанавливаем PostgreSQL 15 
    ...
    Get:15 http://mirror.yandex.ru/ubuntu focal-backports/main i386 Packages [36.1 kB]
    Get:16 http://mirror.yandex.ru/ubuntu focal-backports/main amd64 Packages [45.7 kB]
    Get:17 http://mirror.yandex.ru/ubuntu focal-backports/main amd64 c-n-f Metadata [1,420 B]
    Get:18 http://mirror.yandex.ru/ubuntu focal-backports/universe amd64 Packages [25.0 kB]
    Get:19 http://mirror.yandex.ru/ubuntu focal-backports/universe i386 Packages [13.8 kB]
    ...
    Fetched 15.3 MB in 4s (3,719 kB/s)                                 
    ...
    Fetched 78.6 MB in 13s (6,191 kB/s)                                                                                                                                                                                            
    ...
    Get:5 http://apt.postgresql.org/pub/repos/apt focal-pgdg InRelease [117 kB]                               
    Get:6 http://apt.postgresql.org/pub/repos/apt focal-pgdg/main amd64 Packages [264 kB]
    Fetched 380 kB in 1s (267 kB/s)    
    Reading package lists... Done
    ...
    Fetched 41.6 MB in 6s (7,062 kB/s)                                               
    Preconfiguring packages ...
...
> ### 2. Создаем публикацию таблицы test и подписываемся на публикацию таблицы test2 с ВМ №2.
  ...
  * Устанавливаем PostgreSQL 15 
    ...
    id: epdov2sfakogbuijq2rg
    folder_id: b1g59qc1dbgj9fu1qp9t
    created_at: "2023-05-28T20:34:24Z"
    name: pg-srv2
    zone_id: ru-central1-b
    platform_id: standard-v2
    resources:
    ...
    boot_disk:
      mode: READ_WRITE
      device_name: epda7lkhiqbgd3tmbo65
      auto_delete: true
      disk_id: epda7lkhiqbgd3tmbo65
    network_interfaces:
      - index: "0"
        mac_address: d0:0d:18:f8:b8:f5
        subnet_id: e2lamcqbnklme222m12r
        primary_v4_address:
          address: 10.129.0.22
          one_to_one_nat:
            address: 51.250.100.25
            ip_version: IPV4
    gpu_settings: {}
    ...
    Get:18 http://mirror.yandex.ru/ubuntu focal-backports/universe amd64 Packages [25.0 kB]
    Get:19 http://mirror.yandex.ru/ubuntu focal-backports/universe i386 Packages [13.8 kB]
    Get:20 http://security.ubuntu.com/ubuntu focal-security/main i386 Packages [597 kB]
    Get:21 http://mirror.yandex.ru/ubuntu focal-backports/universe amd64 c-n-f Metadata [880 B]  
    Get:22 http://security.ubuntu.com/ubuntu focal-security/main amd64 Packages [2,192 kB]       
    Get:23 http://security.ubuntu.com/ubuntu focal-security/main Translation-en [354 kB]
    Get:24 http://security.ubuntu.com/ubuntu focal-security/main amd64 c-n-f Metadata [13.0 kB]
    Get:25 http://security.ubuntu.com/ubuntu focal-security/restricted amd64 Packages [1,770 kB]
    Get:26 http://security.ubuntu.com/ubuntu focal-security/restricted Translation-en [249 kB]
    Get:27 http://security.ubuntu.com/ubuntu focal-security/universe amd64 Packages [839 kB]
    Get:28 http://security.ubuntu.com/ubuntu focal-security/universe i386 Packages [598 kB]
    Get:29 http://security.ubuntu.com/ubuntu focal-security/universe Translation-en [172 kB]
    Get:30 http://security.ubuntu.com/ubuntu focal-security/universe amd64 c-n-f Metadata [17.8 kB]
    Fetched 15.3 MB in 5s (3,344 kB/s)                                 
    Reading package lists... Done
    Building dependency tree       
    Reading state information... Done
    11 packages can be upgraded. Run 'apt list --upgradable' to see them.
    ...
    Get:15 http://mirror.yandex.ru/ubuntu focal-updates/main amd64 ncurses-term all 6.2-0ubuntu2.1 [249 kB]                                                                                                                        
    Get:16 http://mirror.yandex.ru/ubuntu focal-updates/main amd64 cloud-init all 23.1.2-0ubuntu0~20.04.2 [532 kB]                                                                                                                 
    Fetched 78.6 MB in 13s (6,213 kB/s)                                                                                                                                                                                            
    Preconfiguring packages ...
    (Reading database ... 102583 files and directories currently installed.)
    Preparing to unpack .../ncurses-bin_6.2-0ubuntu2.1_amd64.deb ...
    Unpacking ncurses-bin (6.2-0ubuntu2.1) over (6.2-0ubuntu2) ...
    ...
    Get:18 http://mirror.yandex.ru/ubuntu focal-updates/main amd64 libxslt1.1 amd64 1.1.34-4ubuntu0.20.04.1 [151 kB]
    Get:19 http://mirror.yandex.ru/ubuntu focal-updates/main amd64 sysstat amd64 12.2.0-2ubuntu0.2 [448 kB]
    Fetched 41.6 MB in 4s (11.0 MB/s)                                        
    Preconfiguring packages ...
    Selecting previously unselected package perl-modules-5.30.
    (Reading database ... 139026 files and directories currently installed.)
    Preparing to unpack .../00-perl-modules-5.30_5.30.0-9ubuntu0.3_all.deb ...
